...
<html lang="vi">
<head>
  <link rel="icon" href="https://static-00.iconduck.com/assets.00/supermarket-icon-2048x2048-73nl4xtf.png">
...
<section id = "inventory"><h2>Quản lý nhập kho</h2>
  ...
  <button id="print-btn" style="margin-top:20px;">In phiếu nhập</button>
</section>
